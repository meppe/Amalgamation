...
if is_64bits:
	...
	subprocess.call(["./64bit/./clingo4", "--number="+str(numModels), "--quiet", "--time-limit="+str(clingoTimeLimit), "iterationGeneralize-py.lp", "caslInterface.lp", "generalize.lp", lpFileName])
else:
	print "Running on 32 bit...\n"
	subprocess.call(["./32bit/./clingo4", "--number="+str(numModels), "--quiet", "--time-limit="+str(clingoTimeLimit), "iterationGeneralize-py.lp", "caslInterface.lp", "generalize.lp", lpFileName])	
